...
| Quieres fijar una version concreta | `install.sh --ref v2.6.0` |
...
```bash
wget -qO- https://raw.githubusercontent.com/JhonDavid930/SURICATAMAN/main/install.sh | sudo bash -s -- --ref v2.6.0
```
